                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        <button
                                            ...
                                            disabled={!['PREPARING'].includes(delivery.status)}
                                            className={`px-6 py-3 rounded-lg font-medium transition-all ${formData.status === 'PREPARING'
                                                ? 'bg-yellow-500 text-white shadow-lg ring-2 ring-yellow-300'
                                        ...
                                        <button
                                            ...
                                            disabled={!['IN_TRANSIT'].includes(delivery.status)}
                                    ...
                                    <div className="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                                        <p className="text-xs text-blue-800">
                                            <span className="font-semibold">Status Flow:</span> PREPARING → IN_TRANSIT → DELIVERED
                                            <br />
                                            <span className="text-blue-600">✓</span> Move forward only, never backward
                                            <br />
                                            <span className="text-red-600">⚠</span> CANCELLED only from IN_TRANSIT
                                        </p>
                                    </div>
                                </div>
                            )
